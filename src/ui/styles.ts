...
const badgeGood = `${badgeBase} border-emerald-300 text-emerald-700 bg-emerald-50 dark:bg-emerald-900/20`;
const badgeBad = `${badgeBase} border-rose-300 text-rose-700 bg-rose-50 dark:bg-rose-900/20`;
const badgeWarn = `${badgeBase} border-amber-300 text-amber-700 bg-amber-50 dark:bg-amber-900/20`;
const badgeInfo = `${badgeBase} border-sky-300 text-sky-700 bg-sky-50 dark:bg-sky-900/20`;
const badgeNeutral = `${badgeBase} border-slate-300 text-slate-700 bg-slate-50 dark:bg-slate-900/20`;
const badgeMuted = `${badgeBase} border-slate-200 text-slate-500 bg-slate-50 dark:bg-slate-900/10`;
const badgeMystic = `${badgeBase} border-violet-300 text-violet-700 bg-violet-50 dark:bg-violet-900/20`;
...
export const cls = {
  ...
  // Formulaires
  input:  "w-full rounded-md border bg-background px-3 py-2 text-sm shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary transition",
  select: "w-full rounded-md border bg-background px-3 py-2 text-sm shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary transition appearance-none pr-8 bg-[right_0.6rem_center] bg-no-repeat",
